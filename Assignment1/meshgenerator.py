...
def createScene(root):
    ...
    node.addObject('MeshOBJLoader', name="loader",filename='Rectangular_Membrane_with points v1.obj')
    ...
    node.addObject('VTKExporter', filename='Rectangular_Membrane_with points v1', edges='0', tetras='1', exportAtBegin='1')
